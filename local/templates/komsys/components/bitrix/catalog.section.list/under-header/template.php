					...
					<ul id="second-nav" class="second-menu">
						<?foreach ($arResult["SECTIONS"] as $arSection):?>
							<li id="menu-item-161" class="icon-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-161">
								...
								<a href="<?=$arSection["SECTION_PAGE_URL"]?>"><img src="<?=$arSection["UF_ALTERNATIVE_IMG"]?>" alt="<?=$arSection["UF_ALTERNATIVE_NAME"]?>" style="margin-right: 15px;"><p><?=htmlspecialchars_decode($arSection["UF_ALTERNATIVE_NAME"])?></p></a>
							</li>
						<?endforeach;?>
					</ul>
				</div>
			</div>
			<a href="https://komsys.ru/images/прайс-лист-с-фото.pdf" class="all-btn" target="_blank" onclick="ym(74905594, 'reachGoal', 'downloadPrice'); return true;">
				<i class="svg file"></i>
