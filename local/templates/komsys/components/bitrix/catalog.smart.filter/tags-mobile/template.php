...
$this->addExternalJS("/tags/js/triger.js");
...
<div class="item__catalog__content-block-filters-show">
    ...
    <? foreach ($arLaber as $code => $setValue):
        ...
        foreach ($setValue["VALUES"] as $values) {
            if ($values["DISPLAY_TYPE"] == "F") {
                ...
                ?>
                <?/* dp($triggerClick);*/?>
                <div class="item__catalog__content-block-filters-show-items-mobile _del-filter">
        ...
        <div class="selected-filter-item _del-filter">
            <div class="_target-filter" data-link="<?= $link ?>">
    ...
    <? /*if(!empty($arLaber)):?>
			<a rel="nofollow" href="<?=$arResult["SEF_DEL_FILTER_URL"]?>" class="btn _btn-clear-filter">Сбросить все <span class="mdi mdi-close"></span></a>
		<?endif*/ ?>
</div>
