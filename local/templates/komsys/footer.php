                            ...
                            <div class="item">
								<span class="wpcf7-form-control-wrap your-name">
									<input type="text" name="name" value="" size="40"
                                           ...
                                           aria-required="true" aria-invalid="false" placeholder="Ваше имя" required>
								</span>
                            </div>
                            <div class="item">
								<span class="wpcf7-form-control-wrap your-tel">
									<input type="tel" name="tel" value="" size="40"
                                           class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel"
                                           aria-required="true" aria-invalid="false" placeholder="Ваш номер телефона"
                                           required>
								</span>
                            </div>
                            <div class="policy-item">
                                <i class="svg padlock"></i>
                                <div class="desc">Нажимая отправить Вы соглашаетесь с <a href="/privacy-policy/">политикой
                                        конфиденциальности</a> сайта Ваши данные в безопасности и не будут переданы
                                    третьим лицам
                                </div>
                            </div>
                            <div class="buttons"><input type="submit" value="ОТПРАВИТЬ"
                                                        class="wpcf7-form-control wpcf7-submit all-btn">
...
$APPLICATION->AddHeadString('<meta name="robots" content="' . $robots . '" />', true); ?>
